...
contract Token {
	...
	constructor() public {
		...
		// Initializing all the tokens into the Smart Contract's wallet
	...
	function transfer(address _to, uint256 _value) public returns (bool success) {
		...
		_transfer(msg.sender,_to,_value);   // msg.sender refers to the owner/from address
		return true;
	}	
	...
	*/
	...
	// This function is called from the spender whenever they will transfer tokens on behalf of the token's owner - msg.sender refers to the spender
